--Prisma template: Tekst + foto landscape
INSERT INTO prisma_mcp .templatenarrowcasting (id, entityversion, htmltemplate, name, previewimage_id, defaultimage_id, imageaspectratio) VALUES ( nextval('prisma_mcp .epublisher_sequence'),	1,	'prisma-text-photo-landscape',	'Text Photo Landscape'	,null, null, '32:9');
