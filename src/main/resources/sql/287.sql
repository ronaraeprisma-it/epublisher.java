------------------------ WTC Art Gallery Text + Image Template ---------------------------

select updatespecificschema('world_trade_center',
'
INSERT INTO templatenarrowcasting (id, entityversion, htmltemplate, name, previewimage_id, defaultimage_id, imageaspectratio) VALUES ( nextval(''epublisher_sequence''),	1,	''wtc-art-gallery-text-image'',	''Art Gallery Tekst + Image''	,null, null, ''40 : 37'');
