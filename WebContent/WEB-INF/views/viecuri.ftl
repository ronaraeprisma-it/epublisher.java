...
<head>
	...
	<meta charset="utf-8">
	<link rel="stylesheet" href="${redirect_base}/static/css/medisign/vie-narrowcasting.css?v=${version}" type="text/css" />
</head>
<body>
	...
	<script type="text/javascript" src="${redirect_base}/static/js/narrowcasting-vie.js?v=${version}"></script>
