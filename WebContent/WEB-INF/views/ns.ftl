...
<head>
	...
	<meta charset="utf-8">
	<link rel="stylesheet" href="${redirect_base}/static/css/prisma-it/ns-narrowcasting.css?v=${version}" type="text/css" />
</head>
<body>
	<video
		id="brightcovePlayer"
	...
	<iframe id="iframe1" scrolling="no" frameborder="0"></iframe>
	...
	<div id="image">
		<img src="${redirect_base}/static/images/blank.png" alt="" />
	</div>
	...
	<div id="errorBackground">
		<img id="testscreen" src="${redirect_base}/static/images/NS.png" alt="" />
	</div>
	...
	<script type="text/javascript" src="${redirect_base}/static/js/narrowcasting-ns.js?v=${version}"></script>
	...
	<script type="text/javascript" src="${redirect_base}/static/js/jquery.webticker.js"></script>
