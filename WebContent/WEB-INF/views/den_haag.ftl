...
<head>
	...
	<meta charset="utf-8">
	<link rel="stylesheet" href="${redirect_base}/static/css/prisma-it/deh-narrowcasting.css?v=${version}" type="text/css" />
</head>
<body>
	...
	<script type="text/javascript" src="${redirect_base}/static/js/narrowcasting-deh.js?v=${version}"></script>
