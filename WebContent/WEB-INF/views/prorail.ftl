...
<head>
	...
	<meta charset="utf-8">
	<link rel="stylesheet" href="${redirect_base}/static/css/prisma-it/prail-narrowcasting.css?v=${version}" type="text/css" />
</head>
<body>
	...
	<script type="text/javascript" src="${redirect_base}/static/js/narrowcasting-prail.js?v=${version}"></script>
